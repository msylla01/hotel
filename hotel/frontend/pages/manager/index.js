...
export default function ManagerDashboard() {
  ...
  useEffect(() => {
    ...
    console.log('🔐 Vérification auth gérant [msylla01] - 2025-10-04 02:16:50')
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      console.log('🏨 Récupération dashboard gérant [msylla01] - 2025-10-04 02:16:50')
  ...
  const handleNavClick = (pageName, href) => {
    ...
    // Vérifier que les données d'auth sont toujours présentes avant navigation
    const token = localStorage.getItem('hotel_token')
    const userData = localStorage.getItem('hotel_user')
    
    if (!token || !userData) {
      console.log('❌ Données auth perdues avant navigation')
  ...
  const getRoomStatusColor = (room) => {
    ...
    if (minutesLeft < 0) return 'bg-red-100 text-red-800 border-red-300'
    if (minutesLeft < 30) return 'bg-yellow-100 text-yellow-800 border-yellow-300'
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-2">msylla01 • 2025-10-04 02:16:50</p>
        </div>
      </div>
    )
  }
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex justify-between items-center py-4">
              ...
              <nav className="hidden md:flex items-center space-x-6">
                ...
                <Link 
                  ...
                  onClick={(e) => {
                    if (!handleNavClick('Séjour Horaire', '/manager/booking/hourly')) {
                      e.preventDefault()
                    }
                  }}
                >
                ...
                <Link 
                  ...
                  className="text-gray-600 hover:text-blue-600 transition-colors"
                  onClick={(e) => {
                    if (!handleNavClick('Nuitée', '/manager/booking/nightly')) {
                      e.preventDefault()
                    }
                  }}
                >
                ...
                <Link 
                  ...
                  className="text-gray-600 hover:text-blue-600 transition-colors"
                  onClick={(e) => {
                    if (!handleNavClick('Séjour prolongé', '/manager/booking/extended')) {
                      e.preventDefault()
                    }
                  }}
                >
                ...
                <Link 
                  ...
                  className="text-gray-600 hover:text-blue-600 transition-colors"
                  onClick={(e) => {
                    if (!handleNavClick('Rapports', '/manager/reports')) {
                      e.preventDefault()
                    }
                  }}
                >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div className="hidden md:block">
                    ...
                    <p className="text-xs text-blue-600">
                      🏨 {user?.role === 'ADMIN' ? 'Admin' : 'Gérant'} • ✅ Connecté
                    </p>
                  </div>
                </div>
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          {/* Vue d'ensemble avec status connexion */}
          <motion.div
          ...
          >
            <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 text-white">
              ...
              <div className="text-xs text-blue-200 mb-4">
                ✅ Connecté : {user?.email} • Rôle : {user?.role} • Pages disponibles : 4
              </div>
          ...
          {/* Actions rapides avec gestion de navigation sécurisée */}
            ...
            {[
              ...
              >
                <Link
                  ...
                  onClick={(e) => {
                    if (!handleNavClick(action.title, action.href)) {
                      e.preventDefault()
                    }
                  }}
                >
          ...
          >
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm text-gray-500">
                Mise à jour: {new Date().toLocaleTimeString('fr-FR')} • Pages créées ✅
              </div>
            </div>
                      ...
                      {!room.isOccupied && (
                        <div className="mt-3 space-y-2">
                          <Link
                            ...
                            onClick={(e) => {
                              if (!handleNavClick('Réservation Horaire', `/manager/booking/hourly?roomId=${room.id}`)) {
                                e.preventDefault()
                              }
                            }}
                          >
                          ...
                          <Link
                            ...
                            onClick={(e) => {
                              if (!handleNavClick('Réservation Nuitée', `/manager/booking/nightly?roomId=${room.id}`)) {
                                e.preventDefault()
                              }
                            }}
                          >
          ...
          {/* Footer info avec status des pages */}
          <div className="mt-8 text-center text-gray-500 text-sm">
            <p className="mb-2">
              🏨 Espace Gérant • Pages créées ✅ • msylla01 • 2025-10-04 02:16:50
            </p>
            <div className="flex justify-center space-x-4 text-xs">
              <span>✅ Horaire: /manager/booking/hourly</span>
              <span>✅ Nuitée: /manager/booking/nightly</span>
              <span>✅ Prolongé: /manager/booking/extended</span>
              <span>✅ Rapports: /manager/reports</span>
