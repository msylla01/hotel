...
export default function ExtendedBooking() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      // Définir dates par défaut (aujourd'hui → demain)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error('❌ Erreur création réservation prolongée [msylla01]:', error)
  ...
  if (success) {
    return (
      <>
        <Head>
          <title>Séjour Prolongé Créé - Espace Gérant</title>
        </Head>
          ...
          >
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <span>Imprimer Reçu Complet</span>
              </button>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center py-4">
              <div className="flex items-center space-x-4">
                ...
                <h1 className="text-xl font-bold text-gray-900">Séjour Prolongé</h1>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <span className="bg-purple-100 text-purple-800 px-2 py-1 rounded text-xs">Gérant</span>
              </div>
            </div>
          </div>
        </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Notes particulières pour ce séjour prolongé..."
                  rows={3}
